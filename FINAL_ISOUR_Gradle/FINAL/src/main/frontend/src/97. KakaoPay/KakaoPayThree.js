...
class KakaoPayThree extends React.Component {
  ...
  componentDidMount() {
    ...
    axios({
      ...
      headers: {
        ...
        Authorization: "KakaoAK 89d3e37be70cc0b1974a049cf22b8d09",
